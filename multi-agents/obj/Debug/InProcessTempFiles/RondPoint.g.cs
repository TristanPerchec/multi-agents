...
namespace multi_agents {
    ...
    public partial class RondPoint : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(RondPoint).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(RondPoint));
        ...
        private string FindResource() {
            string[] resources = typeof(RondPoint).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".RondPoint.g.xaml") || resource.Equals("RondPoint.g.xaml"))) {
                    return resource;
                }
            }
